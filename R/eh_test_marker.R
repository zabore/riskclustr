...
#'
#' @description \code{eh_test_marker} takes a list of individual disease markers
...
#' with a row for each risk factor and a column for each tumor marker.
#'
...
#' factor and a column for each tumor marker.
#'
