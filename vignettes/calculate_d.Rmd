...
We supply `d()`, with specification of the name of the subtype variable, the number of subtypes, a list of risk factors, and the dataset. See the function documentation for details of argument specification.
