...
[![Build Status](https://travis-ci.com/zabore/riskclustr.svg?branch=master)](https://travis-ci.com/zabore/riskclustr)
...
This package is documented using [pkgdown](https://pkgdown.r-lib.org/articles/pkgdown.html), and the resulting website is available at [http://www.emilyzabor.com/riskclustr/](http://www.emilyzabor.com/riskclustr/), where detailed Tutorials can be found covering all of the package functionality.

See [http://www.emilyzabor.com/riskclustr/reference/](http://www.emilyzabor.com/riskclustr/reference/) for detailed function documentation.
